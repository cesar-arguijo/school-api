...
class SessionService
{
     ...
     *
     * @param Uuid $user The user logging in.
     * @param Uuid $device The device from which the user logs in.
     * @return Session The newly created session.
     */
    public function createSession(Uuid $userId, Uuid $deviceId): Session
    {
